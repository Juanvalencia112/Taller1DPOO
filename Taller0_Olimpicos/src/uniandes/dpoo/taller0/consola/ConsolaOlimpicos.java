...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Buscar el país de un atleta");
	...
	{
		System.out.println("\n" + "País de un atleta específico" + "\n");
		String atleta = input ("Por favor ingrese el nombre completo de un atleta");
		String pais = calculadora.ejecutarPaisporAtleta(atleta);
		
		System.out.println(atleta + " es del país " + pais + "." );
	}
